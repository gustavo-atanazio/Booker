...
import reviewsByBook from './_data/reviewsByBook';
...
function BookDetails() {
  ...
  const relatedBooks = getRelatedBooks(book.id, book.genre);
  const reviews = reviewsByBook['default'];
        ...
        <div className='mx-auto px-4 py-8 max-w-7xl'>
          ...
          <div className='flex items-start gap-6 md:gap-10'>
            ...
            <div className='flex-1 min-w-0'>
              <span className='inline-block bg-yellow-400 mb-3 px-3 py-1 rounded-full font-semibold text-black text-xs'>
                {book.genre}
              </span>

              <h1 className='mb-1 font-bold text-2xl md:text-4xl'>{book.title}</h1>
              <p className='mb-3 text-gray-400 text-base md:text-lg'>{book.author}</p>
              ...
              <div className='flex items-center gap-3 mb-5'>
                ...
                <span className='text-gray-500 text-sm'>({book.ratingsCount.toLocaleString('pt-BR')} avaliações)</span>
              </div>
              ...
              {submitted ? (
                ...
                <>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className='px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-400 w-full text-gray-700 text-sm transition-all resize-none placeholder-gray-400'
                  />
            ...
            <div className='bg-white p-5 border border-gray-100 rounded-2xl'>
              ...
              <div className='flex flex-col gap-3'>
                <div className='flex items-center gap-3 text-sm'>
                  ...
                  <span className='ml-auto font-medium text-gray-900'>{book.year}</span>
                </div>
                ...
                <div className='flex items-center gap-3 text-sm'>
                  ...
                  <span className='ml-auto font-medium text-gray-900'>{book.pages}</span>
                </div>
                ...
                <div className='flex items-center gap-3 text-sm'>
                  ...
                  <span className='ml-auto font-medium text-gray-900 text-right'>{book.genre}</span>
                </div>
                    ...
                    >
                      ...
                      <div className='flex-1 min-w-0'>
                        ...
                        <div className='flex items-center gap-1 mt-1'>
                          ...
                          <span className='font-medium text-gray-600 text-xs'>{b.rating}</span>
                        </div>
                      </div>
                    </Link>
                  ))}
