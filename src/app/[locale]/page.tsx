            ...
            <div className='flex-1 max-w-2xl'>
              ...
              <div className='flex gap-8'>
                <div>
                  ...
                  <p className='text-gray-500 text-xs uppercase tracking-wide'>{t('hero.stats.books')}</p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-gray-500 text-xs uppercase tracking-wide'>{t('hero.stats.readers')}</p>
                </div>
                ...
                <div>
                  ...
                  <p className='text-gray-500 text-xs uppercase tracking-wide'>{t('hero.stats.reviews')}</p>
                </div>
              </div>
              ...
              <div className='flex gap-2 mt-10'>
                {books.map((_, i) => (
                  <button
                    ...
                    className={`h-[3px] rounded-full transition-all duration-400 ${i === bgIndex ? 'w-7 bg-yellow-400' : 'w-2.5 bg-white/25 hover:bg-white/50'
                      }`}
                  />
                ))}
              </div>
            ...
            {featured && (
              <div className='hidden lg:flex flex-col flex-shrink-0 items-center w-52 xl:w-60'>
                <div className='flex items-center self-start gap-1.5 mb-3'>
                  ...
                  <span className='font-semibold text-yellow-400 text-xs uppercase tracking-widest'>{t('featured.badge')}</span>
                </div>
                  ...
                  <div className='group relative shadow-2xl rounded-2xl ring-1 ring-white/10 overflow-hidden'>
                    ...
                    <div className='absolute inset-0 flex justify-center items-end bg-black/0 group-hover:bg-black/50 pb-5 transition-colors duration-300'>
                      <div className='flex items-center gap-1.5 bg-yellow-400 opacity-0 group-hover:opacity-100 px-4 py-2 rounded-full font-bold text-black text-xs transition-opacity duration-300'>
                        {t('featured.viewMore')} <ArrowRight className='w-3.5 h-3.5' />
                      </div>
                    </div>
                  </div>
                </Link>
      ...
      <section className='bg-[#F5F5F5] pt-2 pb-6'>
        <div className='mx-auto px-4 max-w-7xl'>
          <div className='flex justify-between items-center mb-4'>
            ...
            >
              {t('popular.viewAll')} <ArrowRight className='w-3 h-3' />
            </Link>
          </div>
        ...
        <div className='flex lg:flex-row flex-col gap-8'>
          ...
          <aside className='flex flex-col flex-shrink-0 gap-6 lg:w-80'>
                  ...
                  >
                    ...
                    <div className='flex-1 min-w-0'>
                      ...
                      <div className='flex items-center gap-1 mt-1'>
                        ...
                        <span className='text-gray-400 text-xs'>({book.ratingsCount.toLocaleString(locale)})</span>
                      </div>
                    </div>
                  </Link>
                ))}
            ...
            <div className='bg-black p-5 rounded-2xl text-white'>
              <h3 className='mb-2 font-bold text-lg'>{t('join.title')}</h3>
