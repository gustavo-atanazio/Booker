  ...
  return (
    <div className='bg-white hover:shadow-sm p-4 border border-gray-100 rounded-2xl transition-shadow'>
      <div className='flex gap-3'>
        <div className={`w-10 h-10 rounded-full ${colorMap[activity.user.color] || 'bg-gray-500'} flex items-center justify-center flex-shrink-0`}>
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex justify-between items-start gap-2'>
            <div>
              ...
              <span className='text-gray-500 text-sm'> {actionLabels[activity.action] || activity.action}</span>
            </div>
